...
%Knowing what the variables will represent for our equation, 
We can now see
...
%\includegraphics[width=0.3\textwidth]{PH4CAX3L}
	...
	%The left panel shows the main window,
...
%that for an exercise. But 
I can compare the $\tau _{measured}$ (the $T$ parameter in our fit) to the $\tau
