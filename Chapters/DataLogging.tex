...
\includegraphics[width=3.614in,height=2.3981in%
]{PH4CAX47}
...
5.1214in,height=1.9294in]{PH4CAX4A}
\end{figure}
...
Since this is an Adafruit product, there is a nice tutorial on wiring up the
